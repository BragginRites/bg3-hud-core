...
export class FilterContainer extends BG3Component {
    ...
    _autoCheckUsed() {
        ...
        if(!game.settings.settings.get(BG3CONFIG.MODULE_NAME + '.synchroBRMidiQoL') || !game.settings.get(BG3CONFIG.MODULE_NAME,'synchroBRMidiQoL') || !ui.BG3HOTBAR.components.container.components.activeContainer) return;
