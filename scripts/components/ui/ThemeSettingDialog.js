 ...
 */
export class ThemeSettingDialog extends BG3Dialog {
    static DEFAULT_OPTIONS = {
        ...super.DEFAULT_OPTIONS,
        id: 'bg3-hud-core-theme-settings',
        classes: [...(super.DEFAULT_OPTIONS.classes || []), 'bg3-theme-settings'],
        window: {
    ...
    /**
     * Build the body content (theme sections)
    ...
    _buildBody() {
        ...
        return this.sections.map(section => this._renderSection(section, baseTheme)).join('');
    }

    /**
     * Build footer with Reset and Save buttons
     * @returns {string} HTML string
     * @override
     */
    _buildFooter() {
    ...
    /**
     * Hook for subclass render setup - bind live preview and reset button
    ...
    /**
     * Handle form submission - save theme settings
